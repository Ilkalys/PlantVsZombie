...
public class MenuLevelComplete extends GameScreen {
	...
	public MenuLevelComplete() {
		//Stop toute musique au d�marrage
		SoundPlayer.StopBGM();
	}
	...
	public void dessine() {
		...
		StdDraw.picture(0.5, 0.5, SPRITEFILEPATH + "/bg/MenuLevelComplete.png", 1, 1);
	
		//Affichage du Texte
		StdDraw.setPenColor(StdDraw.WHITE);
		StdDraw.setFont(new Font("sans serif",10,50 * Game.getCanvasXY() /1000));
		StdDraw.text(0.5, 0.93, "Felicitations!");
		StdDraw.setFont(new Font("sans serif",10,40 * Game.getCanvasXY() /1000));
		StdDraw.text(0.5, 0.88, "Niveau reussi !");

		if(SoundPlayer.getBGMClip() != null)
			StdDraw.picture(0.5, 0.2, SPRITEFILEPATH + "/bg/dancefloor.png", 0.5, 0.5);

		//Affichage des Boutons
		StdDraw.picture(0.3, crossYPosition, SPRITEFILEPATH + "/set/CrossL.png",0.4,0.8);
		StdDraw.picture(0.7, crossYPosition, SPRITEFILEPATH + "/set/CrossR.png",0.4,0.8);

		//Affichage des Danseurs si la musique est d�marr�e
		if( SoundPlayer.getBGMClip() != null) {
			animation();
		}
		// Si la musique n'est pas d�marr�e, affichage des danseurs si il reste moins de 5s � launchSong
		else if(launchSong.getActualTime() <= 0.5 ) {
			StdDraw.picture(0.5, 0.2, SPRITEFILEPATH + "/bg/dancefloor.png", 0.5, 0.5);
			StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_2.png", 0.2, 0.2);
			StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_2.png", 0.2, 0.2);
		}
		// Si la musique n'est pas d�marr�e, affichage des ombres des danseurs si il reste plus de 5s � launchSong + descente des Boutons
		else {
			StdDraw.picture(0.5, 0.5, SPRITEFILEPATH + "/bg/Fondu.png",1,1);
			StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_shadow.png", 0.2, 0.2);
			StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_shadow.png", 0.2, 0.2);
			crossYPosition -= 0.02;
		}
	...
	private void animation() {
		if((actualTime >= 1.142*3 && actualTime <= 1.142*4) || (actualTime >= 1.142*7 && actualTime <= 1.142*8) ||(actualTime >= 1.142*11 && actualTime <= 1.142*12) || (actualTime >= 1.142*15 && actualTime <= 1.142*16) ||(actualTime >= 1.142*19 && actualTime <= 1.142*20)) {
			if(actualTime % 1.142 >= 0.8565) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_10.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_10.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.571) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_9.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_9.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.2855) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_7.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_8.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 <= 0.2855) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_8.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_7.png", 0.2, 0.2);
			}
		}
		else if(actualTime >= 1.142*16 && actualTime <= 1.142*19){
			if(actualTime % 1.142 >= 0.8565) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_6.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_6.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.571) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_5.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_5.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.2855) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_6.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_6.png", 0.2, 0.2);
			...
			if(actualTime % 1.142 >= 0.8565) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_0.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_0.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.571) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_6.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_6.png", 0.2, 0.2);
			...
			if(actualTime % 1.142 >= 0.8565) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_4.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_4.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.571) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_3.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_3.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.2855) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_2.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_2.png", 0.2, 0.2);
			...
			if(actualTime % 1.142 >= 0.8565) {
				...
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_1.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_1.png", 0.2, 0.2);
			}
			else if(actualTime % 1.142 >= 0.2855) {
				StdDraw.picture(0.4, 0.38, SPRITEFILEPATH + "/mob/matthieu/matthieu_0.png", 0.2, 0.2);
				StdDraw.picture(0.6, 0.38, SPRITEFILEPATH + "/mob/julien/julien_0.png", 0.2, 0.2);
