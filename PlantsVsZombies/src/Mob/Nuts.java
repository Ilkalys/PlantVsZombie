...
public class Nuts extends Plant {
	...
	*/
	...
	/**
	 * Retourne le timer charg� de calculer le temps de rechargement pour planter une noix
	 * 
	 * @return Cooldown timer charg� de calculer le temps de rechargement pour planter une noix
	 */
